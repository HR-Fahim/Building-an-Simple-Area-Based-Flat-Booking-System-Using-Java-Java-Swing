...
public class SignUp {
	...
	private void initialize() {
		...
		SignUpframe.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Java Project\\Icons\\7.jpg"));
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Java Project\\Jframe img\\3.jpg"));
