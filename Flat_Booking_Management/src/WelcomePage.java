...
public class WelcomePage {
	...
	private void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Java Project\\Jframe img\\4.gif"));
		lblNewLabel.setBounds(0, 0, 794, 571);
		WelcomePage.getContentPane().add(lblNewLabel);
		WelcomePage.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Java Project\\Icons\\1.png"));
