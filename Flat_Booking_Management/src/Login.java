...
public class Login {
	...
	private void initialize() {
		...
		frmLoginToSweethome.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Java Project\\Icons\\4.png"));
		frmLoginToSweethome.setBounds(500, 100, 676, 517);
		frmLoginToSweethome.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frmLoginToSweethome.setLocationRelativeTo(null);
		...
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Java Project\\Jframe img\\2.jpg"));
