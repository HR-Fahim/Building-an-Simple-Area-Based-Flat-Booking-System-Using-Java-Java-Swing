...
public class ReEnter {
	...
	private void initialize() {
		...
		frmSignUpFailed.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Java Project\\Icons\\6.png"));
		...
		frmSignUpFailed.setLocationRelativeTo(null);
		frmSignUpFailed.getContentPane().setLayout(null);

		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon("C:\\Java Project\\Icons\\6.png"));
