...
public class Flat2 {
	...
	private void initialize() {
		...
		frmFlatSelection.getContentPane().setBackground(SystemColor.activeCaption);
...
//			}
		...
		JLabel lblRoom = new JLabel("FLT1.1");
		...
		JLabel lblFlt = new JLabel("FLT2.1");
		lblFlt.setForeground(Color.BLACK);
		...
		JLabel lblFlt_1 = new JLabel("FLT3.1");
		lblFlt_1.setForeground(Color.BLACK);
		...
		JLabel lblFlt_2 = new JLabel("FLT4.1");
		...
		JLabel lblFlt_3 = new JLabel("FLT5.1");
		lblFlt_3.setForeground(Color.BLACK);
		...
		JLabel lblFlt_4 = new JLabel("FLT6.1");
		lblFlt_4.setForeground(new Color(0, 0, 0));
		...
		JLabel lblFlt_5 = new JLabel("FLT7.1");
		lblFlt_5.setForeground(Color.BLACK);
		...
		JLabel lblFlt_6 = new JLabel("FLT8.1");
		lblFlt_6.setForeground(Color.BLACK);
		...
		JLabel lblFlt_7 = new JLabel("FLT9.1");
		lblFlt_7.setForeground(Color.BLACK);
		...
		JLabel lblFlt_8 = new JLabel("FLT10.1");
		lblFlt_8.setForeground(Color.BLACK);
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					if (!SELECTION1.isEmpty()) {
						String path = "C:\\Java Project\\FamilySelection\\Common1.txt";
